...
public class MesFactoryController {
	...
	public ModelAndView stepStart(String id, String step, String outstorageid, String fhistoryRemark, String submit,
			SearchFactoryParam param, PageQuery page, ModelAndView model) {
		if (submit.equals("工序派工")) {
			if(step.equals("工序结束")) {
				factoryService.endStep(id,outstorageid,fhistoryRemark);
			}else {
