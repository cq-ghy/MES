$(function() {// 页面开始加载
	...
	// ////////////////////////////////////////////////////////////
	//质检过程页面跳转
	function factoryCheckInfo(){
		$(".factory-check").click(function(e){
			//阻止默认事件
			e.preventDefault();
			//阻止事件传播
			e.stopPropagation();
			...
			search_prostatus = $("#search_prostatus").val();
			// 发送请求
			window.location.href="/factory/factoryCheckInfo.page?id="+id+"&keyword="+keyword+"&fromTime="+fromTime+"&toTime="+toTime+"&storageid="+storageid+"&search_prostatus="+search_prostatus;
		});
	}
	// ////////////////////////////////////////////////////////////
	//生产过程页面跳转
...
//			window.location.href="/factory/factoryInfo.json?"+id;
			...
			search_prostatus = $("#search_prostatus").val();
			// 发送请求
			window.location.href="/factory/factoryInfo.page?id="+id+"&keyword="+keyword+"&fromTime="+fromTime+"&toTime="+toTime+"&storageid="+storageid+"&search_prostatus="+search_prostatus;
		});
	}
	// ////////////////////////////////////////////////////////////
	// 日期显示
