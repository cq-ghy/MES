...
<%@ include file="/template/factory/factoryHistoryListTemplate.jsp" %>
<script src="factoryhistory.js"></script> 
...
<body class="no-skin" youdao="bind" style="background: white">
	...
	<div class="page-header">
		<h1>
			生产查询 <small><i class="ace-icon fa fa-angle-double-right"></i>
				查询</small>
		</h1>
	</div>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="dataTables_length" id="dynamic-table_length">
									...
									<!-- <input id="storageid" type="hidden" name="storageid" value="5"/> -->
